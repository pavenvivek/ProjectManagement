...
<head>
	...
	<style type="text/css">
		...
		<%@ include file="resources/css/metisMenu.min.css"%>
		<%@ include file="resources/css/timeline.css"%>
		<%@ include file="resources/css/startmin.css"%>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">${fn: length(recieved_msgs)}</div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">${fn: length(tasks)}</div>
                                        <div>New Tasks!</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-bar-chart-o fa-fw"></i> Customer Satisfaction Rating Chart
...
<!--                             /.panel-body -->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-bar-chart-o fa-fw"></i> Product Release Count Chart
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default btn-xs dropdown-toggle"
                                                data-toggle="dropdown">
...
<!--                         </div> -->
        ...
        <script type="text/javascript">
			...
			<%@ include file="resources/js/metisMenu.min.js"%>
			<%@ include file="resources/js/raphael.min.js"%>
			<%@ include file="resources/js/morris.min.js"%>
			<%@ include file="resources/js/morris-data.js"%>
			<%@ include file="resources/js/startmin.js"%>
		</script>
